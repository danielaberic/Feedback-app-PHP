...
<?php 
$name=$email=$body=$rating=$url='';
$nameErr=$bodyErr=$emailErr=$ratingErr=$urlErr='';
...
if(isset($_POST['submit'])){
  ...
  //provjera ocjene
  if($_POST['rating']>6){
    $ratingErr='Rating has to be in 1-5 range';
  }else{
...
if (empty($nameErr) && empty($emailErr) && empty($bodyErr) && empty($urlErr) && empty($ratingErr)) {
  // add to database
...
?>
    ...
    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF'])?>" method="POST" class="mt-4 w-75">
      ...
      <div class="mb-3">
        ...
        <input type="number" class="form-control <?php echo !$ratingErr? :'is-invalid'; ?>" id="rating" name="rating" placeholder="Enter your rating">
        <div class="invalid-feedback">
          <?php echo $ratingErr; ?>
        </div>
      </div>
      <div class="mb-3">
        ...
        <input type="url" class="form-control <?php echo !$urlErr? :'is-invalid'; ?>" id="url" name="url" placeholder="Enter video URL">
        <div class="invalid-feedback">
          <?php echo $urlErr; ?>
        </div>
      <div class="mb-3">
